...
function topK(args) {
    ...
    if (backend.shouldExecuteOnCPU([x])) {
        var xVals = backend.readSync(x.dataId);
        var _a = topKImplCPU(xVals, x.shape, x.dtype, k, sorted), allTopKVals = _a[0], allTopKIndices = _a[1];
        return [
...
export { GPGPUContext as GPGPUContext };
export { MathBackendWebGL as MathBackendWebGL };
export { forceHalfFloat as forceHalfFloat };
export { gpgpu_util as gpgpu_util };
export { setWebGLContext as setWebGLContext };
export { version as version_webgl };
export { webgl as webgl };
export { webgl_util as webgl_util };
